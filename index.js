...
(function () {
  ...
  getPath("/agent_app/template/areas/{id}/issues", function (request, reply) { reply(areaWithIssues(encodeURIComponent(request.params.id))); });
  getPath("/agent_app/template/rooms/{id?}", function (request, reply) { reply(rooms(encodeURIComponent(request.params.id))); });
  getPath("/agent_app/template/rooms/{id}/areas",  function (request, reply) { reply(roomWithAreas(encodeURIComponent(request.params.id))); });
  getPath("/agent_app/template/rooms/areas", function (request, reply) { reply(roomWithAreas()); });
  ...
  server.route({
    ...
    config: {
      ...
      handler: function (request, reply) {
        request.payload.image.pipe(fs.createWriteStream("image_1"));
      }
    }
  });
  ...
  postPath("/agent_app/debug", function (request) {logRequest(request, "DEBUG"); });
